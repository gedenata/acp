  ...
  return (
    <SafeAreaView style={styles.mainBody}>
      ...
      >
        ...
        <View style={{left:40, position:'absolute', marginLeft:10,marginTop:8, marginBottom:8}}>
          <Text style={{fontFamily:'HelveticaNeue', fontSize:16, lineHeight:24}}>Product Catalogue</Text>
        </View>
        <View style={{right:0, marginTop:10, marginBottom:10, position:'absolute', marginRight:20}}>
          <Icon raised name="navigate-next" size={21}/>
        </View>
      </TouchableOpacity>
      <TouchableOpacity  style={styles.MoreItemStyle} onPress={goToPage.bind(this,'Rewards')}>
        ...
        <View style={{left:40, position:'absolute', marginLeft:10,marginTop:8, marginBottom:8}}>
          <Text  style={{fontFamily:'HelveticaNeue', fontSize:16, lineHeight:24}}>Rewards</Text>
        </View>
        <View style={{right:0, marginTop:10, marginBottom:10, position:'absolute', marginRight:20}}>
          <Icon raised name="navigate-next" size={21} />
        </View>
      ...
      <TouchableOpacity  style={styles.MoreItemStyle} onPress={goToPage.bind(this,'CustomerFeedback')}>
      <View style={{left:0, width:25, marginLeft:10, marginTop:4, marginBottom:10, position:'absolute'}}>
          <Icon raised name="insert-comment" size={28}  color="#00854F"/>
        </View>
        <View style={{left:40, position:'absolute', marginLeft:10,marginTop:8, marginBottom:8}}>
          <Text  style={{fontFamily:'HelveticaNeue', fontSize:16, lineHeight:24}}>Customer Support</Text>
        </View>
        <View style={{right:0, marginTop:10, marginBottom:10, position:'absolute', marginRight:20}}>
          <Icon raised name="navigate-next" size={21} />
        </View>
      </TouchableOpacity>
      <TouchableOpacity  style={{height:25, marginTop:20, width:'100%', right:2,left:5, flexDirection:'row', borderStyle:'solid', borderWidth:0, borderColor:'#dbd4d4', borderBottomWidth:0.4, }}>
        <View style={{left:0, position:'absolute', marginLeft:10,}}>
          <Text style={{color:'#191E24',opacity:0.6, fontFamily:'HelveticaNeue-Bold'}}>Supports</Text>
        </View>
      </TouchableOpacity>
      <TouchableOpacity  style={styles.MoreItemStyle} onPress={goToPage.bind(this,'ContactSupport')}>
      <View style={{left:0, width:25, marginLeft:18, marginTop:9, marginBottom:10, position:'absolute'}}>
          <SimpleLineIcons raised name="earphones-alt" size={20}  color="#00854F"/>
        </View>
        <View style={{left:40, position:'absolute', marginLeft:10,marginTop:8, marginBottom:8}}>
          <Text  style={{fontFamily:'HelveticaNeue', fontSize:16, lineHeight:24}}>Contact Support</Text>
        </View>
        <View style={{right:0, marginTop:10, marginBottom:10, position:'absolute', marginRight:20}}>
          <Icon raised name="navigate-next" size={21} />
        </View>
      ...
      <View style={{left:0, width:25, marginLeft:18, marginTop:9, marginBottom:10, position:'absolute'}}>
        ...
        <View style={{left:40, position:'absolute', marginLeft:10,marginTop:8, marginBottom:8}}>
          <Text  style={{fontFamily:'HelveticaNeue', fontSize:16, lineHeight:24}}>Privacy Policy</Text>
        </View>
        <View style={{right:0, marginTop:10, marginBottom:10, position:'absolute', marginRight:20}}>
          <Icon raised name="navigate-next" size={21} />
        </View>
