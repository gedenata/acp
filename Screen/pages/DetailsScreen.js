          ...
          >
            ...
            <View style={{ width:(fontScale > 1.2 ? '90%' : '80%'), flex:2, flexDirection:'row',}}>
              <View style={{position:'absolute',left:0}}>
                ...
                <Text style={{marginTop:2,color:'#FDFDFD',fontWeight:'bold',fontSize:13}}>Final Destination</Text>
              </View>
              <View style={{position:'absolute',right:0}}>
                ...
                <Text style={{marginTop:2,color:'#FDFDFD',fontSize:13, textAlign:'right'}}>{data.Header.FinalDestination}</Text>
              </View>
            </View>
          </View>
